...
class Monitor:
    ...
    def send_packet(self, packet, packet_type=None):
        ...
        ssid = packet.info
        print(ssid)
        # resp = packet.getlayer(Dot11ProbeResp)
        ...
        #final = '{}{}{}{}{}{}{}{}{}{}{}'.format(self.tap, self.assoc, seen_sender, self.myaddr, seen_sender, '\x00\x00', self.caps, self.SSIDparams(ssid), self.rest, self.RSN, self.ht)
        final = self.test
    ...
    def search_auth(self, mp_queue):
        ...
        print('started')
        sniff(iface=self.mon_ifc, filter='type mgt subtype probe-resp',
